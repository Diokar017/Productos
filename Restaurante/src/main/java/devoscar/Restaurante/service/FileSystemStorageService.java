...
import devoscar.Restaurante.controllers.FilesController;
import devoscar.Restaurante.notFoundException.StorageFileNotFoundException;
import devoscar.Restaurante.storageException.StorageException;
...
public class FileSystemStorageService<StorageProperties> implements StorageService {
    ...
    public FileSystemStorageService(StorageProperties properties) {
        this.storageLocation = Paths.get(properties.toString());
    }
